...
for r = 1:t
    ...
    %% Canal BSC:
    p = prob(r);
    vFinal3 = BSC(p,vFinal3);
    % Algoritmo de Viterbi:
    msg = Decodificador(m,vFinal3,estados);
    % Porcentagem de erro:
    e = mod(u+msg,2);
    [n,m] = size(u);
    ...
    %% Canal BSC:
    p = prob(r);
    vFinal4 = BSC(p,vFinal4);
    % Algoritmo de Viterbi:
    msg4 = Decodificador(m,vFinal4,estados4);
    % Porcentagem de erro:
    e4 = mod(u+msg4,2);
    [n,m] = size(u);
    ...
    %% Canal BSC:
    p = prob(r);
    vFinal6 = BSC(p,vFinal6);
    % Algoritmo de Viterbi:
    msg6 = Decodificador(m,vFinal6,estados6)
    % Porcentagem de erro:
    e6 = mod(u+msg6,2);
    [n,m] = size(u);
